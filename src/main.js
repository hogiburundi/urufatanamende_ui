...
import {
  faCheck, faTimes, faUsers, faSignOutAlt, faSearch, faUnlock, 
  faPen, faShoppingCart, faBox, faBoxOpen, faChartBar,
  faHandHoldingUsd, faTrashAlt, faPlus, faListAlt, faEye, faEyeSlash
